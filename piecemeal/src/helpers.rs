...
///
/// While practically identical to `Cow`, this type has no requirements for `T` being `Clone`, and so can be used purely
/// for generalizing over owned and borrowed variants of a value.
